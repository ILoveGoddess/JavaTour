						...
						<tr>
							...
							<td> 
								...
								<table width="95%" border="0" align="center" cellpadding="2"
									...
									<caption  align="right" ><a href="../sbbx/sbbx!list.do?rs=0&as=0">更多...</a>  </caption>
									<tr>
									...
									<tr align="center">
										...
										<td bgcolor="#FFFFFF">
											<a href="../xj/xjfpxz.do?repairId=${repair.repairId}"><img src="../images/fix.gif" title="分配小组" border="0"></a>
