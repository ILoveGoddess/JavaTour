					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="98%">
								...
								<span class="sys_list_yh">系统管理&gt;&gt;部门列表</span>
							</td>
						</tr>
					</table>
					<br />
							...
							<td>
									...
									<tr>
										<td>
											<input name="button" type="image" src="../images/add.gif"
												class="input_button9" value="新增" onclick="window.location.href='../dept/toAddDept.do'" />
								<table width="100%" border="0" align="center" cellpadding="2"
									...
									<tr align="center">
										...
										<td bgcolor="#FFFFFF">
											<c:if test="${dept.totalUser == 0}">
                                           <a href="../dept/deleteDept.do?departmentId=${dept.departmentId }"><img src="../images/del.gif" title="删除"  onClick="return confirm('确定删除此信息吗？')" border="0"></a>
                                         	</c:if>
                                         <a href="../dept/toUpdateDept.do?departmentId=${dept.departmentId }"><img src="../images/fix.gif" title="编辑" border="0"></a>
										</td>
							...
							<td width="62%">
								...
								<font color="black">共</font><font color="black">${pageinfo.totalRecord}</font>
									...
									<c:if test="${pageinfo.curpage != 1}">
								        <a href="../dept/deptList.do?curpage=1">首页</a>
								        <a href="../dept/deptList.do?curpage=${pageinfo.curpage-1 }"> 上一页</a>
								    </c:if>
								    <c:if test="${pageinfo.curpage != pageinfo.totalPage}">
									    <a href="../dept/deptList.do?curpage=${pageinfo.curpage+1 }"> 下一页</a>
									    <a href="../dept/deptList.do?curpage=${pageinfo.totalPage }"> 尾页</a>
									</c:if>  
								     <input  id="pagebox" size="1" name=""></input>&nbsp;
								              <a onclick="goto2('../dept/deptList.do?curpage=');" href="#">跳转</a>&nbsp;
