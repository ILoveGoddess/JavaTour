...
<form name="saleCollectionClass/saleCollectionPath" method="post" name="form1" id="form1">
							...
							<select name="_pageSize" onchange="toUrl('_null','_pageSize_up')" id="_pageSize_up">
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
                                  ...
                                  <c:forEach items="${saleCollection }" var="saleCollection">
	                                  <tr class="select_content_bg">
	                                    <td align="center">
											<input type="checkbox" name="gather_id" value="${saleCollection.id}" onclick="changeNum();">
										</td>
	                                    <td><a href="load4EditGather.action?edit_id=${saleCollection.id}&CId=${saleCollection.cId}" class="normal">${saleCollection.code }</a></td>
	                                    <td align="center">
	                                    	<fmt:formatDate value="${saleCollection.payDate }" pattern="yyy年MM月dd日hh:mm:ss"/>
	                                    </td>
	                                    <td align="center">${saleCollection.cName }</td>
	                                    <td align="center">${saleCollection.total }</td>
	                                    <td align="center">${saleCollection.handler }</td>
	                                    <td align="center">${saleCollection.status }</td>
	                                  </tr>
                                  </c:forEach>
                                  <tr>
                                    <td colspan="7">&nbsp;</td>
