...
<body>
<form action="productType/productTypeListOne" method="post" name="form1" id="form1">
					    ...
					    <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
					      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                            <tr>
                              ...
                              <td width="25%"><input type="text" name="code" class="inputTextStyle" value="${code}"></td>
                              <td width="10%">商品类别名称:</td>
                              <td width="27%"><input type="text" name="name" class="inputTextStyle" value="${name}"></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_table">
					  ...
					  <tr>
					    <td height="16" valign="top"><br/>
					        <img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='productType/toAddProductType'">
					        <img src="image/s7.gif" width="59" height="22" alt="删除按钮" onclick="toDel();">
							<img src="image/shuxing.gif" onclick="openTreeWindow();" width="62" height="22" />
						</td>
			          </tr>
					  <tr>
					  ...
					  <tr>
						...
						<select name="_pageNum" onchange="toUrl('_pageNum_up','_null');"
							...
							<c:forEach begin="1" end="${pager.totalPage }" varStatus="sta">
								<option value="${sta.count }" <c:if test="${pager.page==sta.count }">selected="selected"</c:if>  >第${sta.count }页</option>
							</c:forEach>
							...
							<option value="50" <c:if test="${pager.pageSize==50 }">selected="selected"</c:if>>50条</option>
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
                                  ...
                                  <c:forEach items="${productTypeList }" var="bproductType">

								<tr class="select_content_bg">
									<td align="center">
									 	<input type="checkbox" name="productType_id" value="${bproductType.id}" onclick="changeNum();">
									</td>
                                    <td>${bproductType.name}
                                    	<a style="text-decoration:none;" href="productType/toUpdateProductType?productTypeId=${bproductType.id }"><span style="color:red;font:30px; font-weight:bold;">修改${bproductType.name}</span></a>
                                    </td>
						...
						<td width="40%" height="19" bgcolor="#f2faff"
							style="font-size: 12px;">&nbsp;<img src="image/t2.gif"
							align="absmiddle" width="15" height="16"> 导出 | 选择条目:<span id="select_num2">0</span></td>
						<td width="3%" bgcolor="#f2faff" style="font-size: 12px;">&nbsp;</td>
						<td width="57%" bgcolor="#f2faff" align="right"
							style="font-size: 12px;">共${pager.totalRecord}条 <span
							class="pager" onclick="firstPage();" style="cursor: pointer">首页</span>
