...
<form action="saleOrderClass/SaleOrderListOne" method="post" name="form1" id="form1">
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<img style="margin-left: 5px;" src="image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight: bold; font-size: 12px;">销售单</span></td>
			</tr>
			<tr>
				<td height="46" align="left" valign="middle" bgcolor="#f7fbfc"
					style="font-size: 12px; color: #424446;">草稿 待审核 已审核 已驳回 <span
					style="color: #FF0000">全部</span></td>
			</tr>
		</table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td height="21" background="image/index_main_div_titleBg.gif"><img
					...
					style="font-weight: bold; font-size: 12px;">销售单搜索</span></td>
			</tr>
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
					<tr>
						...
						<td width="10%" align="left"><img src="image/s2.gif"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td height="16" valign="top"><br />
					<img src="image/s3.gif" width="62" height="22"  onclick="javascript:window.location.href='saleOrderClass/toAddSaleOrder'">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td width="4%" height="28" align="center" background="image/select_title_title.jpg">
									<input type="checkbox" name="checkbox" id="ids" value="checkbox" onclick="toChange();">
								</td>
							...
							<c:forEach items="${saleOrder }" var="saleOrder">
								<tr class="select_content_bg">
									<td align="center">
										<input type="checkbox" name="order_id" value="${saleOrder.id}" onclick="changeNum();">
									</td>
									<td><a href="load4EditOrder.action?edit_id=${saleOrder.id}" class="normal">${saleOrder.code}</a></td>
									<td align="center"><fmt:formatDate value="${saleOrder.orderDate}" pattern="yy年MM月dd日"/></td>
									<td align="center">${saleOrder.cName}</td>
									<td align="center">${saleOrder.salesman }</td>
									<td align="center">${saleOrder.total}</td>
									<td align="center">${saleOrder.agioTotal}</td>
									<td align="center">${saleOrder.total * saleOrder.agioTotal}</td>
									<td align="center">${saleOrder.auditor}</td>
									<td align="center">${saleOrder.status}</td>
								</tr>
							</c:forEach>
							<tr>
								<td colspan="10">&nbsp;</td>
