...
<body>
<form action="productDataClass/ProductDataListOne" method="post" name="form1" id="form1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="10%">商品名称:</td>
						<td width="18%"><input type="text" name="textfield"
							class="inputTextStyle"></td>
						<td width="9%">商品编码:</td>
						<td width="18%"><input type="text" name="textfield4"
							class="inputTextStyle"></td>
						<td width="14%">拼音码:</td>
						<td width="15%"><input type="text" name="textfield42"
							class="inputTextStyle" /></td>
						<td width="7%"><img src="image/s1.gif" width="59" height="22"></td>
						<td width="7%" align="left"><img src="image/s2.gif" width="62"
							height="22"></td>
					...
					<tr>
						...
						<td width="18%"><input type="text" name="textfield4"
							class="inputTextStyle"></td>
						<td width="14%">单价:</td>
						<td width="15%">从 <input type="text" name="textfield422"
							size="5" /> 到 <input type="text" name="textfield4222" size="5" /></td>
						<td width="7%">&nbsp;</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td height="16" valign="top"><br />
					<img src="image/s3.gif" width="62" height="22"  onclick="javascript:window.location.href='productDataClass/toAddProductData'">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<c:forEach items="${productData }" var="productData">
								<tr class="select_content_bg">
									<td align="center">
										<input type="checkbox" name="product_id" value="${productData.id}" onclick="changeNum();">
									</td>
									<td>
									${productData.name}
									<a style="text-decoration:none;" href="javascript:;"><span style="color:red;font:30px; font-weight:bold;">修改${productData.name}</span></a>
									</td>
									<td align="center">${productData.code}</td>
									<td align="center">${productData.productTypeName }</td>
									<td align="center">${productData.model}</td>
									<td align="center">${productData.spec}</td>
									<td align="center">${productData.productSize}</td>
									<td align="center">${productData.stock}</td>
									<td align="center">${productData.price}</td>
								</tr>
							</c:forEach>
							<tr>
								<td colspan="9">&nbsp;</td>
