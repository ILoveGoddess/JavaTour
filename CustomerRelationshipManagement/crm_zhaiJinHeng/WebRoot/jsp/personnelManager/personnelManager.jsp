...
<body>
<form action="personnelManagerClass/PersonnelManagerListOne" method="post" name="form1" id="form1">
              ...
              <tr>
                <td valign="middle" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
					  <tr>
						<td height="21" background="image/index_main_div_titleBg.gif"><img style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">人事管理</span></td>
					  </tr>
					</table>
					
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
					  <tr>
						<td height="21" background="image/index_main_div_titleBg.gif"><img style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">人员搜索</span></td>
					  </tr>
					  <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_table">
					  ...
					  <tr>
					    <td height="11"><img src="image/t1.gif" align="absmiddle"> <span style="font-size:14; font-weight:bold;">人员列表</span></td>
				      </tr>
					  <tr>
					    <td height="16" valign="top"><br/>
					        <img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='personnelManagerClass/toAddPersonnelManager'">
					        <img src="image/s7.gif" onclick="toDel();">
					        <img src="image/qiyong.gif" width="59" height="22">
					        <img src="image/tingyong.gif" width="59" height="22">
				        </td>
			          </tr>
					  <tr>
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
                                  <tr>
                                    ...
                                    <td width="10%" align="left" background="image/select_title_title.jpg"><strong>用户名</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>中文名</strong></td>
                                    <td width="14%" align="center" background="image/select_title_title.jpg"><strong>操作权限组</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>查询权限组</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>所属部门</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>起始有效期</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>终止有效期</strong></td>
                                    <td width="10%" align="center" background="image/select_title_title.jpg"><strong>状态</strong></td>
                                  </tr>
                                  <c:forEach items="${personnelManager }" var="personnelManager">
										<tr class="select_content_bg">
											<td align="center">
												<input type="checkbox" name="user_id" value="${personnelManager.id}" onclick="changeNum();">
											</td>
		                                    <td><a href="load4EditUser.action?edit_id=${personnelManager.id}" class="normal">${personnelManager.name}</a></td>
		                                    <td align="center">${personnelManager.cnname}</td>
		                                    <%--.role --%>
		                                    <td align="center">${personnelManager.handleJurisdictionName}</td>
		                                    <%--.accessGroup --%>
		                                    <td align="center">${personnelManager.deptManagerName}</td>
		                                    <%--.userGroup. --%>
		                                    <td align="center">${personnelManager.queryJurisdictionName}</td>
		                                    <td align="center"><fmt:formatDate value="${personnelManager.beginDate}" pattern="yyy年MM月dd日"/></td>
		                                    <td align="center"><fmt:formatDate value="${personnelManager.endDate}" pattern="yyy年MM月dd日 "/></td>
		                                    <td align="center">${personnelManager.status}</td>
	                                  </tr>
                                  </c:forEach>
                                  <tr>
                                    <td colspan="5">&nbsp;</td>
