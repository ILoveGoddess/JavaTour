...
function exportExcel(){
	...
	function openTreeWindow(accessGroup_id){
		window.open("load4SetAccessGroup.action?id="+accessGroup_id,"_blank",
...
<form action="queryJurisdictionClass/QueryJurisdictionListOne" method="post" name="form1" id="form1">
	...
	<tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td width="17%"><input type="text" name="textfield"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<span style="font-size: 14; font-weight: bold;">查询权限列表</span></td>
			</tr>
			<tr>
				<td height="16" valign="top"><br />
					<img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='queryJurisdictionClass/toAddQueryJurisdiction'">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td width="52%" align="center"
									background="image/select_title_title.jpg"><strong>可查看的范围</strong><strong></strong></td>
							</tr>
							
							 <c:forEach items="${queryJurisdiction }" var="queryJurisdiction">
								<tr class="select_content_bg">
									<td align="center">
										<input type="checkbox" name="accessGroup_id" value="${queryJurisdiction.id}" onclick="changeNum();">
									</td>
									<td>${queryJurisdiction.id}</td>
									<td align="center">${queryJurisdiction.name}</td>
									<td align="center"><span onclick="openTreeWindow('${queryJurisdiction.id}')" style="cursor: pointer">设置</span></td>
								</tr>
							</c:forEach>
							<tr>
								<td colspan="4">&nbsp;</td>
