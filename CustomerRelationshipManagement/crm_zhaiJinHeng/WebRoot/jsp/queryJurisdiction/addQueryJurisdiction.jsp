...
function submitForm(){
	document.getElementById("accessGroupForm").submit();
}
</script>
</head>

<body STYLE='OVERFLOW:SCROLL;OVERFLOW-X:HIDDEN'>
<form name="form1" method="post" action="queryJurisdictionClass/addQueryJurisdiction" id="accessGroupForm">
<input type="hidden" name="edit_id" id="edit_id" value="" />
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_main_table">
              <tr>
                <td height="26" width="100%"> <span style="color:#002450; font-size:13px; font-weight:bold;">　查询权限组-创建/修改</span></td>
              </tr>
</table>
			...
			<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_content">
              ...
              <tr>
                <td valign="middle" ><table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
                  ...
                  <tr>
                    <td height="56" align="left" valign="top" bgcolor="#f7fbfc"><form name="form1" method="post" action="">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                          <tr>
                            ...
                            <td width="41%"><input type="text" name="name" value="${queryJurisdiction.name }" class="addCText"></td>
                          ...
                          <tr>
                            <td>备注:</td>
                            <td colspan="3"><textarea name="remark" class="addCText2">${queryJurisdiction.remark }</textarea></td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
                    </form></td>
