...
function checkBoxNum(){
	if($("input[name='userGroup_id']:checked").length > 0){
		return $("input[name='userGroup_id']:checked").length;
	}else{
		return 0;
	}
}
...
<body>
<form action="deptManagerClass/DeptManagerListOne" method="post" name="form1" id="form1">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_table">
					  ...
					  <tr>
					    <td height="16" valign="top"><br/>
					        <img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='deptManagerClass/toAddDeptManager'">
							...
							<select name="_pageSize" onchange="toUrl('_null','_pageSize_up')" id="_pageSize_up">
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
                                  ...
                                  <c:forEach items="${deptManager }" var="deptManager">
	                                  <tr class="select_content_bg">
	                                    <td align="center">
											<input type="checkbox" name="userGroup_id" value="${deptManager.id}" onclick="changeNum();">
										</td>
	                                    <td>${deptManager.name}</td>
	                                    <td align="center">${deptManager.principal}</td>
	                                    <td align="center">${deptManager.incumbent}</td>
	                                    <td align="center"><a href="javascript:openSetUserWindow('${deptManager.id}');" class='normal'>设置</a></td>
	                                  </tr>
                                  </c:forEach>
                                  <tr>
                                    <td colspan="5">&nbsp;</td>
